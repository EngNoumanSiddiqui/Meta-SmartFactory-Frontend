...
@Component({
  selector: 'quality-inspection-characteristic-catalog-group-detail',
  templateUrl: './detail.component.html'
})
export class DetailQualityInspectionCharacteristicCatalogGroupComponent implements OnInit {
