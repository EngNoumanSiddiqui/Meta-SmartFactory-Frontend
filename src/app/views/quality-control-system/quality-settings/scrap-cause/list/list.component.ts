...
export class ScrapCauseListComponent implements OnInit {
  ...
  cols = [
    ...
    {field: 'scrapDescription', header: 'scrap-description', index:4},
    {field: 'scrapType', header: 'scrap-type', index:5},
    {field: 'setup', header: 'setup', index:6},
    {field: 'scrapRawMaterial', header: 'input-scrap', index:7},
    {field: 'scrapMaterial', header: 'output-scrap', index:8},
    {field: 'createAutoProdOrder', header: 'create_auto_prod', index:9},
    {field: 'createDate', header: 'create-date', index:10},
    {field: 'updateDate', header: 'update-date', index:11}
  ];
