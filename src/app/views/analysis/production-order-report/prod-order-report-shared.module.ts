...
import { ProductionOrderReportComponent } from './prod-order-report.component';
import { ProdOrderAutoCompleteModule } from 'app/views/auto-completes/prod-order-auto-complete/prod-order-autocomplete.module';
import { ProdOrderReportChartComponent } from './prod-order-report-chart/prod-order-report-chart.component';
...
export class ProductionOrderReportSharedModule {
}
