...
@Component({
  selector: 'app-job-order-gantt-view',
  templateUrl: './job-order-gantt-view.component.html'
})
export class JobOrderGanttViewComponent implements OnInit {
  sub: Subscription;
  barData: any;
  options: any;
  subInterval: Subscription;
  @Input() allocationReport: any;
