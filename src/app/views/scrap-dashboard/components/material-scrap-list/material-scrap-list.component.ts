...
@Component({
  selector: 'app-material-scrap-list',
  templateUrl: './material-scrap-list.component.html',
  styleUrls: ['./material-scrap-list.component.scss']
})
export class MaterialScrapListComponent implements OnInit {
