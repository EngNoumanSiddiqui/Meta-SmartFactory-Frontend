...
@Component({
  selector: 'app-monthly-mttr-line-graph',
  templateUrl: './monthly-mttr-line-graph.component.html',
  styleUrls: ['./monthly-mttr-line-graph.component.scss']
})
export class MonthlyMttrLineGraphComponent implements OnInit {
