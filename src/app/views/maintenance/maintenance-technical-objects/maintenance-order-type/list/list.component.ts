...
@Component({
  selector: 'maintenance-order-type-list',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss']
})
export class MaintenanceOrderTypeListComponent implements OnInit {
  ...
  selectedData = [];
  selectedColumns = [
    {field: 'maintenanceOrderTypeId', header: 'order-type-id'},
    {field: 'maintenanceOrderType', header: 'order-type'},
    {field: 'maintenanceOrderTypeName', header: 'description'},
  ...
  pageFilter = {
    ...
    plantId: null,
    query: null,
    orderByProperty: 'maintenanceOrderTypeId',
  ...
  constructor(private _confirmationSvc: ConfirmationService,
              ...
              private mOrderTypeTypeSvc: MaintenanceOrderTypeService) {
  ...
  ngOnInit() {
    this.searchTerms.pipe(
      debounceTime(400),
      switchMap(term => this.mOrderTypeTypeSvc.filterObservable(this.pageFilter))).subscribe(
      result => {
