...
@Component({
  selector: 'maintenance-system-condition-list',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss']
})
export class MaintenanceSystemConditionListComponent implements OnInit {
  ...
  selectedData = [];
  selectedColumns = [
    {field: 'maintenanceSystemConditionId', header: 'system-condition-id'},
  ...
  pageFilter = {
    ...
    active: null,
    query: null,
    orderByProperty: 'maintenanceSystemConditionId',
  ...
  constructor(private _confirmationSvc: ConfirmationService,
              ...
              private mSystemConditionTypeSvc: MaintenanceSystemConditionService) {
  ...
  ngOnInit() {
    this.searchTerms.pipe(
      debounceTime(400),
      switchMap(term => this.mSystemConditionTypeSvc.filterObservable(this.pageFilter))).subscribe(
      result => {
  ...
  delete(id) {
    this._confirmationSvc.confirm({
      ...
      icon: 'fa fa-trash',
      accept: () => {
        this.mSystemConditionTypeSvc.delete(id)
          .then(() => {
