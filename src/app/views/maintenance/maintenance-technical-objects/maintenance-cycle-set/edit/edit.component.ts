 ...
 */
@Component({
  selector: 'maintenance-cycle-set-edit',
  templateUrl: './edit.component.html'
})
export class EditMaintenanceCycleSetComponent implements OnInit {
  dummyArray: any[] = [];
id; 
modal = {active: false};
...
@Input('id') set z(id) {
 ...
 @Input('data') set setDataz(data) {
  this.packageDataModel = data;
  if (data) {
    this.dataModel.maintenanceStrategyPackageList = [];
    this.dataModel.maintenanceStrategyPackageList.push(this.packageDataModel);
  }
};
...
resetNewItemDetails() {
  this.packageDataModel = {
    ...
    maintenanceCycleText: null,
    maintenanceStrategyId: null,
    plantId : this.packageDataModel.plantId,
    maintenanceStrategyPackageId: null,
    offset: 0,
    offsetShortText: null,
    packageNumber: 0
