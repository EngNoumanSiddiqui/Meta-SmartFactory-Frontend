...
@Component({
  selector: 'maintenance-notification-type-list',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss']
})
export class MaintenanceNotificationTypeListComponent implements OnInit {
  ...
  selectedData = [];
  selectedColumns = [
    {field: 'maintenanceNotificationTypeId', header: 'notification-type-id'},
  ...
  pageFilter = {
    ...
    active: null,
    query: null,
    orderByProperty: 'maintenanceNotificationTypeId',
  ...
  constructor(private _confirmationSvc: ConfirmationService,
              ...
              private mNotificationTypeTypeSvc: MaintenanceNotificationTypeService,
  ...
  ngOnInit() {
    this.searchTerms.pipe(
      debounceTime(400),
      switchMap(term => this.mNotificationTypeTypeSvc.filterObservable(this.pageFilter))).subscribe(
      result => {
  ...
  delete(id) {
    this._confirmationSvc.confirm({
      ...
      icon: 'fa fa-trash',
      accept: () => {
        this.mNotificationTypeTypeSvc.delete(id)
          .then(() => {
