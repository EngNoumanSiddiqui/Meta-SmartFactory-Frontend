...
@Component({
  selector: 'code-group-header-list',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss']
})
export class CodeGroupHeaderListComponent implements OnInit, OnDestroy {
  ...
  selectedData = [];
  selectedColumns = [
    {field: 'equipmentCodeGroupHeaderId', header: 'catalog-id'},
      {field: 'equipmentCodeGroup', header: 'code'},
    {field: 'codeGroup', header: 'short-text-for-code'},
    {field: 'shortText', header: 'status-of-code-group'}
  ];
  cols = [
    {field: 'equipmentCodeGroupHeaderId', header: 'catalog-id'},
      {field: 'equipmentCodeGroup', header: 'code'},
