...
export class ListComponent implements OnInit , OnDestroy{
  ...
  pageFilter = {
    ...
    orderByProperty: 'currencyRecordId',
    plantId: null,
    query: null,
  };
  locationModal ? = {
  ...
  cols = [
    {field: 'currencyRecordId', header: 'currency-record-id'},
    {field: 'rate', header: 'rate'},
    {field: 'fromCurrencyCode', header: 'from-currency-code'},
    {field: 'toCurrencyCode', header: 'to-currency-code'},
  ...
  ngOnInit() {
    ...
    this.searchLocationTerms.pipe(
      debounceTime(600),
      switchMap(term => this.exchangeRateService.filterObservable(term))).subscribe(result => {
