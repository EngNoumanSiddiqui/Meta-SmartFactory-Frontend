...
export class ListComponent implements OnInit, OnDestroy {
  ...
  cols = [
    ...
    {field: 'operationTypeDescription', header: 'operation-type-description'},
             ...
             private appState: AppStateService,
                ...
                this.sub = this.appState.plantAnnounced$.subscribe(res => {
                  if ((res) && res.plantId) {
                    ...
                    this.getOperationTypeById(this.pageFilter.plantId);
                  } else {
  ...
  getOperationTypeById(plantId: any) {
    if ((plantId)) {
      this.operationTypeService.getDetailByPlantId(plantId).then(result => {
  ...
  filter() {
    ...
    this.operationTypeService.operationTypefilter().then(result => {
  ...
  delete(id) {
    this._confirmationSvc.confirm({
      ...
      icon: 'fa fa-trash',
      accept: () => {
        this.operationTypeService.operationTypedelete(id)
          .then(() => {
