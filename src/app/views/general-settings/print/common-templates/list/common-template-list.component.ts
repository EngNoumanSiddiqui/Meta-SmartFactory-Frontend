...
@Component({
  selector: 'common-template-list',
  templateUrl: './common-template-list.component.html',
  styleUrls: ['./common-template-list.component.scss']
})
export class CommonTemplateListComponent implements OnInit {
  cmsList: any[];
  selectedParts: any;
