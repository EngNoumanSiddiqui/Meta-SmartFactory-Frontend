...
@Component({
  ...
  styleUrls: ['./notification-dashboard.css'],
...
export class NotificationDashboardComponent implements OnInit, OnDestroy {
  ...
  filterWithRoute() {
    if(this.previouUrlSvr.getCurrentUrl() == "/inventory-management/warehouse-management-system/advance/notification-dashboard-dispatcher/dispatcher"
      ...
      } else if(this.previouUrlSvr.getCurrentUrl() == "/inventory-management/warehouse-management-system/advance/notification-dashboard"
       && this.previouUrlSvr.getPreviousUrl() !== '/inventory-management/warehouse-management-system/advance/notification-management') {
        this._stockNotificationSvc.stockTransferPageOpenFirstTime = false;
        this._stockNotificationSvc.resetFilter();
        this.search(this.pageFilter);
      }
