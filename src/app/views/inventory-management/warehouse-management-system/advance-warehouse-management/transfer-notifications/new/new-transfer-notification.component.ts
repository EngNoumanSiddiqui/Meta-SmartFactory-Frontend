...
export class NewStockTransferNotificationComponent implements OnInit, OnDestroy {
  ...
  onSelectStockReport(event) {
    this.newRequestCreateStockTransferDetailListItemDto.barcode = event.barcode;
    this.newRequestCreateStockTransferDetailListItemDto.locationNo = event.locationNo;
    this.newRequestCreateStockTransferDetailListItemDto.batchFrom = event.batch;
    this.newRequestCreateStockTransferDetailListItemDto.batch = event.batch;
  }

  onChangegoodMovementDocumentType(event) {
  ...
  onPurchaseOrderDetailChange(event) {
    ...
    this.initialRequestCreateStockTransferDetailListItemDto.referenceId = detailItem.referenceId;
