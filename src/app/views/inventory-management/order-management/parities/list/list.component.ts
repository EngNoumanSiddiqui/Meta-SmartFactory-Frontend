...
export class ListComponent implements OnInit , OnDestroy{
  ...
  cols = [
    {field: 'parityId', header: 'parity-id'},
    {field: 'parityCode', header: 'parity-code'},
    {field: 'parityName', header: 'parity-name'},
  ...
  ngOnInit() {
    ...
    this.searchLocationTerms.pipe(
      debounceTime(600),
      switchMap(term => this.parityService.filterObservable(term))).subscribe(result => {
