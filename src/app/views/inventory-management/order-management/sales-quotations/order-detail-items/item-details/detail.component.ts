...
import {SalesQuotationItemDetails } from 'app/dto/sale-order/sale-order-quotation.model';

@Component({
  selector: 'sales-item-quotations-detail',
  templateUrl: './detail.component.html',
  styleUrls: ['./detail.componet.scss']
})
export class SalesItemQuotationsDetailComponent implements OnInit {
  @ViewChild('myModal') public myModal: ModalDirective;
  // @ViewChild('orderDetailPlan') orderDetailPlanComponent: OrderDetailPlanQuotationsComponent;

  id;
  saleOrder: SalesQuotationItemDetails;
  showLoader = true;
  ...
  public initialize(id: string) {
    ...
    this._saleSvc.getItemDetail(id)
      .then(result => {
        console.log(result);
        this.saleOrder = result as SalesQuotationItemDetails;
