...
import { EquipmentTaskContent, EquipmentTaskResponseObject } from 'app/dto/equipment-task/equipment-task.model';
import { maintenanceStrategyPackageListDto } from 'app/dto/maintenance/strategy.dto';
...
import { TaskOperationService } from 'app/services/dto-services/maintenance-equipment/task-operation.service';
import { MaintenanceStrategyPackageService } from 'app/services/dto-services/maintenance/maintenance-strategy-package.service';
import { EquipmentTaskService } from 'app/services/dto-services/maintenance-equipment/equipment-task.service';
import { ConvertUtil } from 'app/util/convert-util';

@Component({
  selector: 'choose-equipment-task-pane',
  templateUrl: './list.component.html'
})
export class ChooseEquipmentTaskPaneComponent implements OnInit {
