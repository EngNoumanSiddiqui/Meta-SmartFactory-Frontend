...
export class QualityReportTypeService extends BasePageService {
  ...
  filterObservable(data) { 
    return this._httpSvc.postObservable('quality/notificationReportType/filter', data, this._opt.getHeader()); 
  }
  detail(id: string) {
