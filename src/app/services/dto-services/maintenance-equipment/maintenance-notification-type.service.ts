...
@Injectable()
export class MaintenanceNotificationTypeService extends BasePageService {
  ...
  filterObservable(data) { return this._httpSvc.postObservable('maintenance/notificationtype/filter', data, this._opt.getHeader()); }
  filterSharedObservable(data) { return this._httpSharedvc.post('maintenance/notificationtype/filter', data, this._opt.getHeader()); }
}
